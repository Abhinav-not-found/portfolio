...
const ProjectCard = ({ data }) => {
  ...
  return (
    <div className='size-78 md:size-82 bg-neutral-100/60 dark:bg-neutral-800/70 rounded-md p-2  border-neutral-200/50 dark:border-neutral-700 hover:shadow-md group'>
